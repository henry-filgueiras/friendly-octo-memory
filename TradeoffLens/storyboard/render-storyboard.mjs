...
const sourcePath = "file:///Users/henry/friendly-octo-memory/TradeoffLens/storyboard/storyboard.html";
const outputPath =
  "/Users/henry/friendly-octo-memory/TradeoffLens/storyboard/tradeoff-lens-storyboard.png";

const browser = await puppeteer.launch({
  executablePath: chromePath,
  headless: true,
  args: ["--no-sandbox", "--disable-setuid-sandbox"],
  defaultViewport: { width: 1660, height: 2220, deviceScaleFactor: 1 },
});
